...
Using newly available data on executed writs in Virginia, provided by the [Civil Court Data Initiative](https://civilcourtdata.lsc.gov/), we examine the number of executed writs relative to the number of eviction judgments.[^5] 
...
To view these values by Virginia court jurisdictions -- the number and rates of eviction filings, eviction judgments, writs issued, and writs executed -- visit the locality-level table. ADD LINK
