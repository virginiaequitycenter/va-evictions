...
- Connor White &#9708;
- Hannah Woehrle &#9708;
- Jacob Goldstein-Greenwood &#9677; (primary code and document author; [contact](mailto:jacobgg@virginia.edu) with code questions)
- Kathryn Howell &#9708;  
- Michael Salgueiro &#9677;  
- Michele Claibourn &#9677;  
...
# Read in CSV
courts <- read.csv('/Users/jgg/Desktop/equity-center/eviction-project/civilcases/csvs-summaries/by_court_residential_only_wide.csv')
...
acs_locality <- read.csv('/Users/jgg/Desktop/equity-center/va_acs_data_zcta_and_county/household_county_acsdata.csv')
...
cases_res <- read.csv('/Users/jgg/Desktop/equity-center/eviction-project/civilcases/csvs-cases/cases_residential_only.csv')
...
zip_summaries <- read.csv('/Users/jgg/Desktop/equity-center/eviction-project/civilcases/csvs-summaries/by_zip_residential_only.csv')
...
acs_zip <- read.csv('/Users/jgg/Desktop/equity-center/va_acs_data_zcta_and_county/household_zcta_acsdata.csv')
